            ...
            explicit MemPool(std::size_t num_elems):
                ...
                store_(num_elems, {T(), true}) {
                    ASSERT(reinterpret_cast<const ObjectBlock *>(&(store_[0].object_)) == &(store_[0]),
                        "T object should be the first of the object block")
                }
                ...
                T *allocate(Args...args) noexcept {
                    ...
                    ASSERT(obj_block->is_free, "expected fre objective at index:" + std::to_string(next_free_index_));
                ...
                auto deallocalte(const T *elem) noexcept {
