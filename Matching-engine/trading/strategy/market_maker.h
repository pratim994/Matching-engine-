...
namespace Trading {
    ...
    class MarketMaker{
        public :
            ...
            auto onOrderBookUpdate(TicekrId ticker_id, Price price, Side side, const MarketOrderBook *book) noexcept -> void {
                   ...
                   const auto fair_price = feauture_engine_->getMktPrice();
        ...
        logger_->log("%:% %() % % fair-price:%\n", __FILE__, __LINE__, __FUNCTION__,
                     ...
                     const auto bid_price_ =  bbo->bid_price_ - (fair_price - bbo->bid_price_ >= threshold ? 0: 1);

                     const auto ask_price = bbo->ask_price_ + (bb0->ask_price_ -  fair_price >= threshold ? 0 : 1);
            ...
            auto omOrderUpdate(const Exchange::MEClientResponse *client_response) noexcept -> void  {
      ...
      order_manager_->onOrderUpdate(client_response);
            ...
            private: 
                ...
                consst FeatureEngine *feature_engine_ = nullptr;
