...
namespace Trading {
    ...
    class OrderManager {
        ...
        public:
            ...
            auto onOrderUpdate(Const Exchange::MEClientResponses *client_response) noexcept -> void {
        ...
        auto getOMOrdersSideHashMap(TickerId ticker_id) const {
        ...
        OrderManager(const OrderManagerr &&) = delete;
        ...
        private:
            ...
            OMOrderTickerSideMap ticker_side_order_;
