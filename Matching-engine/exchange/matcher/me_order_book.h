...
namespace Exchange {
    ...
    class MEOrderBook final {
        public:
            ...
            //deletion of default , copy and move constructors and assignment operators
            // to enforce RAII paradigm and enforce exception safety
            ...
            auto addOrdersAtPrice(MEOrdersAtPrice *new_orders_at_price) noexcept {
                ...
                if(UNLIKELY(!best_orders_by_price)){
                    ...
                    auto target = best_orders_by_price;
                     ...
                     bool add_after= ((new_orders_at_side_ == Side::SELL && new_orders_at_price_->price_ > target-_>price_) ||
                     (new_orders_at_price->side_ == Side::BUY && new_orders_at_price->price_ < target_->price_)
                    );
