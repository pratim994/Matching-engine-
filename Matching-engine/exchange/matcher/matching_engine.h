...
#include "common/threads_utils.h"
...
#include "order_sserver/client_request.h"
...
namespace Exchange {
    class MatchingEngine final {
        public :
            MatchingEngine(ClientRequestLFQueue *client_requests, ClientResponseLFQueue *client_responses, MEMarketUpdateLFQ *market_updates);
            ...
            auto processClientRequest(const MEClientRequest *client_request) noexcept {
                    ...
                    switch(client_request->type_){
                        case clientRequestType::NEW: {
                            ...
                            client_request->ticker_id_, client_request->side_ ,  client_request->price_ , 
                        ...
                        default :{
                            FATAL("recieved invalid client-request type" 
        ...
        private:
            ...
            ClientResponseLFQueue *outgoing_ogw_request_ = nullptr;

            MEMarketUpdateLFQ *outgoing_md_updates_= nullptr;
