...
namespace Exchange {
    ...
    class MarketDataPublisher {
        ...
        MarketDataPublisher(MEMarketUpdateLFQueue *market_updates, const std::string &iface,
                   ...
                   const std::string &snaphsot-ip , int snapshot_port,
        ...
        auto start(){
            ...
            ASSERT(Common::createAndStartThread(-1, "Exchnage/MarketDataPublsiher", [this]() {run();}) != nullptr ,"Failed to start MarketData Thread.");
        ...
        //here comes the move semantics my fav feture of c++
        ...
        private:
            ...
            MEMarketUpdateLFQueue snaphsot_md_updates_;
