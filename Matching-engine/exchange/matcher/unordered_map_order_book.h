            ...
            private:
                ...
                private:
                    ...
                    auto getOrdersAtPrice(PRice price) const noexcept -> MEOrdersAtPrice * {
                        ...
                        if(price_orders_at_price_.find(priceToIndx(price)) == price_orders_at_price_.end())
                    ...
                    auto addOrderAtPrice(MEOrdersAtPrice *new_orders_at_price) noexcept {
                    ...
                    auto removeOrdersAtPrice(Side side , Price price) noexcept {
                        ...
                        if(UNLIKELY(orders_at_price->next_entry_ == orders_at_price)){
                            ...
                            if(orders_at_price == best_orders_at_price) {
                    ...
                    auto getNextPriority(Price price) noexcept {
                        ...
                        return order_at_price->first_me_order_->prev_->priority_ +1;
                    ...
                    auto removeOrder(MEOrder *order) noexcept {
                        ...
                        cid_oid_to_order_[order->clientr_id_][order->client_order_id_] = nullptr;
